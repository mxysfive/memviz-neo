                ...
                {mainView === "timeline" ? (
                  <>
                    <span className="faint">
                      · {(timeline?.rendered_allocation_count ?? timelineAllocs.length).toLocaleString()}
                      {timeline ? `/${timeline.allocation_count.toLocaleString()}` : ""}
                      {" "}allocs
                    </span>
                    {timeline && timeline.hidden_allocation_count > 0 && (
                      <span className="faint">
                        · {timeline.hidden_allocation_count.toLocaleString()} hidden grouped
                      </span>
                    )}
                    <span className="track-detail" role="group" aria-label="Allocation detail budget">
                      <span className="track-detail-label">Detail</span>
